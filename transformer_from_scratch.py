...
# Load training data
if not os.path.exists('/Users/qiaolin/Desktop/Master-LLM-DL/sales_textbook.txt'):
    url = 'https://huggingface.co/datasets/goendalf666/sales-textbook_for_convincing_and_selling/raw/main/sales_textbook.txt'
    with open('/Users/qiaolin/Desktop/Master-LLM-DL/sales_textbook.txt', 'w') as f:
        f.write(requests.get(url).text)

with open('/Users/qiaolin/Desktop/Master-LLM-DL/sales_textbook.txt', 'r', encoding='utf-8') as f:
    text = f.read()
